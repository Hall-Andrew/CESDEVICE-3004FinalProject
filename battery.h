...
#include <iostream>
/*
 * The purpose of this class is to simulate battery life in the device.
 *      - When the device reaches 5% and 2% it will send out a warning and
 *      - when it reachs 0% it will shut off.
 *
 * Variables:
